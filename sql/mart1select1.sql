...
WHERE (F2._Code = '45')
AND F1.[_Period] BETWEEN '4021.01.01' and '4022.01.01' AND F3.[_Code] = '90.2'
)as subquery
ON d.[_Number] = subquery.Pnumber AND t1.[_LineNo] + 1 = subquery.Pline
WHERE T2._Code = '90.1' AND T1.[_Period] BETWEEN '4021.01.01' and '4022.01.01'
...
WHERE
    ...
    AND f1.[_Period] BETWEEN '4021.01.01' and '4022.01.01'
GROUP BY
    f1.[_Period],
    f1.[_LineNo],
    d2.[_Number],
